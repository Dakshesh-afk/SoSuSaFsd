...
{
    /// <inheritdoc />
    public partial class InitialSetup_WithReports : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryIsRestricted = table.Column<bool>(type: "bit", nullable: false),
                    IsVerified = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryAccessRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategoryAccessRequests_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryAccessRequests_Categories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryAccessRequests_CategoryId",
                table: "CategoryAccessRequests",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoryAccessRequests_UserId",
                table: "CategoryAccessRequests",
                column: "UserId");
